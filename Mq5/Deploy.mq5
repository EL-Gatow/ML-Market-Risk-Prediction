...
// dan tambahkan URL: https://raden.pythonanywhere.com/ ke daftar URL yang diizinkan
...
input string FlaskURL = "https://raden.pythonanywhere.com//predict"; // URL server Flask
...
int OnInit()
{
   ...
   {
      Print("[ERROR] WebRequest tidak diaktifkan. Buka Tools -> Options -> Expert Advisors dan tambahkan URL: https://raden.pythonanywhere.com/");
   }
...
bool CheckWebRequest()
{
   ...
   uchar result[];
   uchar data[];
   int ret = WebRequest("GET", "https://raden.pythonanywhere.com/", headers, 500, data, result, response);
   int errorCode = GetLastError();
   
   if(errorCode == 4060) // Tidak ada izin untuk WebRequest
   {
      Print("[ERROR] WebRequest tidak diizinkan. Buka Tools -> Options -> Expert Advisors dan tambahkan URL: https://raden.pythonanywhere.com/");
      return false;
   }
...
void SendLatestDataToServer()
{
   ...
   string url = "https://raden.pythonanywhere.com//get_latest_data";
